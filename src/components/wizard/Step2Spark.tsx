...
export function Step2Spark() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <p className="text-base text-[#8b949e]">Determine your data engineering and science workload sizes.</p>
      </div>
      ...
      <div className="grid gap-6">
        <Input
          ...
          helperText="Total number of nodes running Spark jobs concurrently."
        />
        ...
        <div className="space-y-1.5 w-full">
          ...
          <p className="text-xs text-[#8b949e] mt-1">Must align to standard cloud node configurations.</p>
        </div>
        ...
        <Input
          ...
          helperText="Average runtime for Spark clusters per day."
        />
      </div>
    </div>
  );
